                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 d-none d-md-flex flex-wrap justify-content-center justify-content-lg-start mb-3 mb-lg-0">
                            <div class="header-bar-email d-flex align-items-center">
                                <i class="fa fa-envelope"></i><a href="#">learnzilla.12@gmail.com</a>
                    ...
                    <div class="row">
                        <div class="col-9 col-lg-3">
                            <div class="site-branding">
                                <h1 class="site-title"><a href="index.php" rel="home">Learn<span>Zilla</span></a></h1>
                            </div><!-- .site-branding -->
                        </div><!-- .col -->
                    ...
                    <div class="col-12">
                        <div class="hero-content-wrap flex flex-column justify-content-center align-items-start">
                            ...
                            <div class="entry-content">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, repudiandae veniam porro autem, corporis nulla obcaecati perspiciatis magni itaque veritatis voluptate id sed praesentium repellendus, vero placeat facilis aliquam molestiae.</p>
                            </div><!-- .entry-content -->
            ...
            <div class="row">
                <div class="col-12 col-lg-6 align-content-lg-stretch">
                    <header class="heading">
                        <h2 class="entry-title">About learnZilla</h2>
                    ...
                    <div class="entry-content learn-zilla-stats">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="foot-about">
                            ...
                            <h1 class="site-title"><a href="index.php" rel="home"><span style="color: #000;">Learn</span><span>Zilla</span></a></h1>
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mt-5 mt-md-0">
                        <div class="foot-contact">
                            ...
                            <ul>
                                <li>Email: rose.learnZilla@hotmail.com</li>
